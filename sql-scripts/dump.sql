...
CREATE TABLE `products` (
  ...
  `categories_en` varchar(255) DEFAULT NULL,
  `brands` varchar(255) DEFAULT NULL,
  `origins_en` varchar(255) DEFAULT NULL,
...
-- Dump completed on 2025-01-19 14:54:26
